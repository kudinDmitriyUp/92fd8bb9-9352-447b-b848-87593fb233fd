...
export const metadata: Metadata = {
  ...
  description: "Scopri Modus Pizzeria a Milano. Autentica pizza cilentana con ingredienti prelibati, tecnica artigianale e passione per la tradizione. Prenota ora.",
  keywords: "pizza Milano, pizza cilentana, ristorante italiano, pizzeria autentica, Paolo De Simone",
  metadataBase: new URL("https://moduspizzeriamilan.it"),
  alternates: {
    canonical: "https://moduspizzeriamilan.it"
  },
  openGraph: {
    title: "Modus Pizzeria - L'Autenticità Cilentana a Milano",
    description: "Autentica pizza cilentana nel cuore di Milano. Ingredienti prelibati, tecnica artigianale, passione per la tradizione.",
    url: "https://moduspizzeriamilan.it",
    siteName: "Modus Pizzeria",
    type: "website",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1764078554692-p68p68uv.jpg",
        alt: "Authentic Italian pizza at Modus Pizzeria"
      }
    ]
  },
  twitter: {
    ...
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1764078554692-p68p68uv.jpg"]
  },
  robots: {
    index: true,
    follow: true
